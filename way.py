...
class Fil(tk.Frame):
    ...
    def create_widgets(self):
        ...
        self.var.set("")
        self.descrebtion.pack(side="top")

        self.filtertime = tk.Checkbutton(self, variable= self.v1)
        ...
        self.filterdatetime = tk.Checkbutton(self, variable= self.v2)
        ...
        self.filtersquare = tk.Checkbutton(self, variable= self.v3)
        ...
        self.filterarea = tk.Checkbutton(self, variable= self.v4)
    ...
    def say_hi(self):
        ...
        self.descrebtio = tk.Label(self, textvariable=self.va, height=2, width=35)
        self.va.set("")
        self.descrebtio.pack(side="left")
